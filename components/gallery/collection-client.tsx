...
import { Lock, Globe, Pencil, Trash2, Check, X, Plus, FolderOpen, Image, MoreVertical, Move, Copy } from 'lucide-react'
        ...
        <AlertDialog open={deleteDialog !== null} onOpenChange={() => setDeleteDialog(null)}>
          <AlertDialogContent>
            ...
            <AlertDialogFooter>
              ...
              <AlertDialogAction onClick={() => deletePhoto(deleteDialog!.id)} className="bg-destructive">Delete</AlertDialogAction>
            </AlertDialogFooter>
          </AlertDialogContent>
        </AlertDialog>
        ...
        <AlertDialog open={movePhotoDialog.open} onOpenChange={() => setMovePhotoDialog({ photo: null, open: false })}>
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>Choose a collection for "{movePhotoDialog.photo?.name}".</AlertDialogDescription>
            </AlertDialogHeader>
            ...
            <AlertDialogFooter>
              <AlertDialogCancel>Cancel</AlertDialogCancel>
              <AlertDialogAction onClick={movePhoto} disabled={!selectedMoveCollection}>Move</AlertDialogAction>
            </AlertDialogFooter>
          </AlertDialogContent>
        </AlertDialog>
      </div>
