...
} сделай чтобы можно было делать фотки не только в коллекциях, но и в вакуум, чтобы они просто были в галлерее несортированными, ок? потом пришлю код галереи
